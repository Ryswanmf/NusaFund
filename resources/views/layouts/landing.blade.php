                    ...
                    @auth
                        <div class="flex items-center gap-3">
                            @if(Auth::user()->usertype !== 'admin')
                                <a href="{{ route('dashboard') }}" class="bg-amber-500 hover:bg-amber-400 text-maroon-950 px-5 py-2 rounded-full font-bold transition shadow-lg shadow-amber-900/20 active:scale-95 text-sm">
                                    Dashboard
                                </a>
                            @endif
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <div class="pt-4 space-y-3">
                    @auth
                        @if(Auth::user()->usertype !== 'admin')
                            <a href="{{ route('dashboard') }}" class="block w-full text-center bg-amber-500 text-maroon-950 py-3 rounded-xl font-bold shadow-lg">Dashboard</a>
                        @endif
